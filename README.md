...
``` bash
git clone https://github.com/RomaTur/ls-sitePortfolio-admin.git
```
...
Запустите сервер с "горячей" перезогрузкой страниц
``` bash
npm run dev
```

Либо соберите проект на продакшн со всеми минификациями
```
npm run build
```
